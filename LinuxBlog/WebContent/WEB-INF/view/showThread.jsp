...
<body>
	...
	<div id="content">
		<section>
			<article>
				<div id="c_center">
					<div class="c_header">${thread.topic}</div>
					<p>${thread.content}</p>
				</div>
			</article>
		</section>
		<section>
			<div class="commentsDisplay">
				<c:forEach var="comment" items="${comments}">
					<span style="color: black"> ${user.login}
			...
			<c:if test="${sessionScope.user.login ne null }">
				<div class="commentsForm">
					<form action="" method="post">
						<textarea name="commentContent" rows="5" cols="70"
							style="resize: none; margin-bottom: 20px"></textarea>
						<br /> <input type="submit" value="Wyślij komentarz" />
					</form>
				</div>
			</c:if>
		</section>
